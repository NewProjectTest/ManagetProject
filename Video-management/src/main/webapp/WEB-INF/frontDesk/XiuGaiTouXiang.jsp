...
<body class="w100">
	...
	<header>
		...
		<menu>
			<div class="container clearfix">
				...
				<div id="user_bar">
					<a> <img id="avatar" src="./修改头像_files/avatar_lg.png" alt="""="">
			...
			<div class="proflle_tab_body">
				<div class="proflle_tab_workplace clearfix">
					<div class="profile_avatar_area">
						...
						<img src="./修改头像_files/avatar_lg.png">
					...
					<div class="profile_ifo_area">
						<form id="upload_form" action="#">
							...
							<p>第一步：请选择图像文件</p>
							<div>
								<input name="image_file" id="image_file"
	...
	<footer>
		<div class="container">
			<ul>
				<li><img src="./修改头像_files/footer_logo.png" alt=""
					id="foot_logo"></li>
