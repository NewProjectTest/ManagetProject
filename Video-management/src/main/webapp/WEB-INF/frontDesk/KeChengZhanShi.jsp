...
<body class="w100" style="padding-top: 0px;">
	<header>
		<div class="container">
			...
			<div id="userBlock" style="float: right">
				<a>退出</a> <a id="account">1@qq.com</a>
			</div>



			<a onclick="JavaScript:addFavorite2()"><img
				src="./课程展示_files/sc.png" draggable="false">加入收藏</a> <a
				target="_blank"><img src="./课程展示_files/we.png" draggable="false">后台管理</a>
			<a class="color_e4"><img src="./课程展示_files/phone.png"
	...
	<div id="app">
		<!--banner图-->
		<div class="banner">
			<img alt="" src="./课程展示_files/banner-1.jpg" width="100%"
				height="470px;">
		</div>
						...
						<li class="section-main" onclick="getVideo(217)">
							...
							<div class="classify-v-info">
								<span class="count" title="观看次数"><img
									src="./课程展示_files/count.png" alt="">433</span> <span
									class="duration" title="视频时长"><img
									src="./课程展示_files/player.png" alt="">562</span>
							</div>
						</li>
				...
				<div class="section">
					...
					<ul>
						...
						<li class="section-main" onclick="getVideo(245)">
							...
							<div class="classify-v-info">
								<span class="count" title="观看次数"><img
									src="./课程展示_files/count.png" alt="">208</span> <span
									class="duration" title="视频时长"><img
									src="./课程展示_files/player.png" alt="">320</span>
							</div>
						</li>
				...
				<div class="section">
					...
					<ul>
						...
						<li class="section-main" onclick="getVideo(224)">
							...
							<div class="classify-v-info">
								<span class="count" title="观看次数"><img
									src="./课程展示_files/count.png" alt="">191</span> <span
									class="duration" title="视频时长"><img
									src="./课程展示_files/player.png" alt="">907</span>
							</div>
						</li>
		...
		<footer>
			<ul>
				<li><img src="./课程展示_files/footer_logo.png" alt=""
					draggable="false"></li>
				<li class="mt25">
					<h3>各校区地址</h3>
					<ul>
						...
						<li class="erwei"><br>
							<div>
								<img class="weixin" src="./课程展示_files/a_002.png" alt=""
									...
									src="./课程展示_files/a.png" alt="" draggable="false">
							</div></li>
					</ul>
				</li>
			</ul>
